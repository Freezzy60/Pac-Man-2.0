...
export default class Pacman {
    ...
    draw(ctx, pause, enemies) {
        ...
        //This code make the magic to change the right richtung for pacman animation
        ...
        ctx.drawImage(
            this.pacmanImages[this.pacmanImageIndex], -size, -size,
            this.tileSize,
            this.tileSize
        );
    ...
    keydown = (event) => {
        ...
        //up
        if (event.keyCode == 38) {
            //if you alredy movin down you can switch to up
        ...
        if (event.keyCode == 39) {
            ...
            //if you moving left you can get right
                this.currentMovingDirection = MovingDirection.right;
            //if you moving right and will go down but thers a wall you move right
    ...
    eatPowerDot() {
        if (this.tileMap.eatPowerDot(this.x, this.y)) {
            ...
            let powerDtoAboutToExpireTimer = setTimeout(() => {
                this.powerDotAboutToExpire = true;
            }, 1000 * 3);

            this.timers.push(this.powerDotAboutToExpire);
        }
    }
